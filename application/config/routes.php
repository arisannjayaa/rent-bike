...
$route['alternatif/create'] = 'AlternativeController/create';
$route['alternatif/store'] = 'AlternativeController/store';
$route['alternatif/update/(:num)'] = 'AlternativeController/update/$1';
$route['alternatif/delete/(:num)'] = 'AlternativeController/delete/$1';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
