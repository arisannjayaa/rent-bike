...
<script src="<?= BASEURL ?>assets/extra-libs/multicheck/datatable-checkbox-init.js"></script>
    <script src="<?= BASEURL ?>assets/extra-libs/multicheck/jquery.multicheck.js"></script>
    <script src="<?= BASEURL ?>assets/extra-libs/DataTables/datatables.min.js"></script>
<script>
	/****************************************
	 *       Basic Table                   *
	 ****************************************/
