	...
	<div class="scroll-sidebar">
		...
		<nav class="sidebar-nav">
			<ul id="sidebarnav" class="p-t-30">
				...
				<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark <?= $this->uri->uri_string() == 'kriteria/store' || $this->uri->uri_string() == 'kriteria' || $this->uri->uri_string() == 'bike/store' || $this->uri->uri_string() == 'bike' ? 'active' : '' ?>" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-format-list-bulleted-type"></i><span class="hide-menu">Data</span></a>
					<ul aria-expanded="false" class="collapse  first-level <?= $this->uri->uri_string() == 'kriteria/store' || $this->uri->uri_string() == 'kriteria' || $this->uri->uri_string() == 'subkriteria/store' || $this->uri->uri_string() == 'subkriteria' || $this->uri->uri_string() == 'bike/store' || $this->uri->uri_string() == 'bike' ? 'in' : '' ?>">
						...
						<li class="sidebar-item <?= $this->uri->uri_string() == 'bike/store' || $this->uri->uri_string() == 'bike' ? 'active' : '' ?>"><a href="<?= base_url('') ?>bike" class="sidebar-link"><i class=""></i><span class="hide-menu">Bike</span></a></li>
						<li class="sidebar-item <?= $this->uri->uri_string() == 'alternatif/store' || $this->uri->uri_string() == 'alternatif' ? 'active' : '' ?>"><a href="<?= base_url('') ?>alternatif" class="sidebar-link"><i class=""></i><span class="hide-menu">Alternatif</span></a></li>
					</ul>
				</li>
